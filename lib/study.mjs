...
State the lecture's main ideas directly, not a description of what the study pack covers.
...
appear elsewhere in the lecture. Copy consequential qualifiers faithfully in every output, including
key points: "that morning" must not become "that day"; "only planned difference" must not become
a guarantee of "the only difference". Describe observed counts as counts, not proof of better performance.
Before returning, compare each paraphrase with its quote and remove any broader timing, certainty,
or causal claim. Do not repeat the same question or flashcard target across topics.
